# Converted from PinModes/LiquidCrystal/LQ_Ex01_Test/LQ_Ex01_Test.ino
import SerialWombat
...
lcd0 = SerialWombatLiquidCrystal.SerialWombatLiquidCrystal(sw, 4, 5, 0, 1, 2, 3)
