# Converted from PinModes/LiquidCrystal/LQ_Ex03_40x4/LQ_Ex03_40x4.ino
import SerialWombat
...
lcd0 = SerialWombatLiquidCrystal.SerialWombatLiquidCrystal(sw, 15, 14, 16, 17, 18, 19)
...
def setup():
  ...
  delay(3000)
  print("Liquid Crystal 40x4 Example")
  ...
  q.begin(0, 160, SerialWombatQueue.SerialWombatQueueType.QUEUE_TYPE_RAM_BYTE_SHIFT)
def loop():
  i = 0
