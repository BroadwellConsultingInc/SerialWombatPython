...
def loop():
  ...
  x = 0
  newline = False
  if myKeyboard.isKeyPressed(SCANCODE_UPARROW):
    Serial.print("U"); newline = True
  if myKeyboard.isKeyPressed(SCANCODE_DOWNARROW):
    Serial.print("D"); newline = True
  if myKeyboard.isKeyPressed(SCANCODE_RIGHTARROW):
    Serial.print("R"); newline = True
  if myKeyboard.isKeyPressed(SCANCODE_LEFTARROW):
    Serial.print("L"); newline = True
  if myKeyboard.isKeyPressed(SCANCODE_1):
    Serial.print("1"); newline = True
  if myKeyboard.isKeyPressed(SCANCODE_SPACEBAR):
    Serial.print("S"); newline = True
  # TODO_MANUAL_CONVERSION: if newline) Serial.println(:
