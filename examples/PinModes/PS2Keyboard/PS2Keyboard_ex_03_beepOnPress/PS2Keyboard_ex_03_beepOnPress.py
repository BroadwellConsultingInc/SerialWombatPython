# Converted from PinModes/PS2Keyboard/PS2Keyboard_ex_03_beepOnPress/PS2Keyboard_ex_03_beepOnPress.ino
import SerialWombat
...
# ===== Arduino tab: PS2Keyboard_ex_03_beepOnPress.ino =====
#
...
def setup():
  ...
  # Data Pin
  # Queue ASCII Data
  myKeyboard.begin(PS2_CLK_PIN, PS2_DATA_PIN, 0, 2)
