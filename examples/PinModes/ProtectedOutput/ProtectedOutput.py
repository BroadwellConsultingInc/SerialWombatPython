...
def setup():
  ...
  if sw.isSW08()  and  not (sw.isPinModeSupported(PIN_MODE_ANALOGINPUT)  and  sw.isPinModeSupported(PIN_MODE_PROTECTED_OUTPUT)):
...
def loop():
  if swpo.isInSafeState():
    print("Protected Output Fault Detected, Output set to Safe Statenot ")
  # TODO_MANUAL_CONVERSION: if i  0x01:
