...
# ===== Arduino tab: SW18B_Ard_MatrixKeypad_ex04_queueTM1637.ino =====
#
...
def setup():
  ...
  if sw.isSW08() and not (sw.isPinModeSupported(SerialWombat.SerialWombatPinMode_t.PIN_MODE_MATRIX_KEYPAD) and sw.isPinModeSupported(SerialWombat.SerialWombatPinMode_t.PIN_MODE_TM1637)):
  ...
  myDisplay.begin(14, 15, 6, SerialWombatTM1637.SWTM1637Mode.tm1637CharArray, 0x55, 4)
  # Brightness
...
def loop():
  ...
  if i > 0:
    myDisplay.print(i)
    # We got a keypress.  Dump it to the Display
