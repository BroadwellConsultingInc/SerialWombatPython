...
ContinuousServo = SerialWombatServo.SerialWombatServo(sw)  # Declare a Servo on pin 2 of Serial Wombat sw
StandardServo = SerialWombatServo.SerialWombatServo(sw)  # Declare a Servo on pin 3 of Serial Wombat sw
...
def setup():
  ...
  if sw.isSW08()  and  not sw.isPinModeSupported(PIN_MODE_SERVO):
