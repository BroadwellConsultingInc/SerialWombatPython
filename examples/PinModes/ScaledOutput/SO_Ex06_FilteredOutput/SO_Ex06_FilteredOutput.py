# Converted from PinModes/ScaledOutput/SO_Ex06_FilteredOutput/SO_Ex06_FilteredOutput.ino
import SerialWombat
...
# ===== Arduino tab: SO_Ex06_FilteredOutput.ino =====
#
...
def setup():
  ...
  delay(3000)
  print("Output scaling filtered output control example")
  ...
  sw18ABPWM.write1stOrderFiltering(SerialWombatAbstractScaledOutput.SerialWombatAbstractScaledOutput.Period.PERIOD_1mS, 64224)
def loop():
