...
if (is_micropython()):
    import machine
    from SerialWombat_interface import SerialWombat_mp_i2c
else:
    from SerialWombat_interface import SerialWombatChip_cpy_serial_addressed
...
#   i2c = SMBus(1)
    ...
    global SW8B_68
    SW8B_68 = SerialWombatChip_cpy_serial_addressed(ser,0x68)
    SW8B_68.address = 0x68

    global SW18AB_6B 
    SW18AB_6B = SerialWombatChip_cpy_serial_addressed(ser,0x6B)
    SW18AB_6B.address = 0x6B

    global SW4B_6C
    SW4B_6C = SerialWombatChip_cpy_serial_addressed(ser,0x6C)
    SW4B_6C.address = 0x6C

    global SW4B_6D
    SW4B_6D = SerialWombatChip_cpy_serial_addressed(ser,0x6D)
    SW4B_6D.address = 0x6D
    
    global SW4B_6E
    SW4B_6E = SerialWombatChip_cpy_serial_addressed(ser,0x6E)
    SW4B_6E.address = 0x6E

    global SW4B_6F
    SW4B_6F = SerialWombatChip_cpy_serial_addressed(ser,0x6F)
    SW4B_6F.address = 0x6F
    ...
    def resetAll() -> None:
        ...
        #TODO analogShutdown()
        print("TODO Add analogShutdown() to resetAll() in SW18B_UnitTest_globals.py")
    ...
    SW18AB_PT00 = SerialWombatPulseTimer.SerialWombatPulseTimer(SW4B_6D)
    SW18AB_PT05 = SerialWombatPulseTimer.SerialWombatPulseTimer(SW4B_6D)
    SW18AB_PT06 = SerialWombatPulseTimer.SerialWombatPulseTimer(SW4B_6D)
    SW18AB_PT07 = SerialWombatPulseTimer.SerialWombatPulseTimer(SW4B_6C)
    SW18AB_PT08 = SerialWombatPulseTimer.SerialWombatPulseTimer(SW4B_6D)
    SW18AB_PT09 = SerialWombatPulseTimer.SerialWombatPulseTimer(SW4B_6C)
    SW18AB_PT10 = SerialWombatPulseTimer.SerialWombatPulseTimer(SW4B_6C)
    SW18AB_PT11 = SerialWombatPulseTimer.SerialWombatPulseTimer(SW4B_6C)
    SW18AB_PT12 = SerialWombatPulseTimer.SerialWombatPulseTimer(SW4B_6E)
    SW18AB_PT13 = SerialWombatPulseTimer.SerialWombatPulseTimer(SW4B_6F)
    SW18AB_PT14 = SerialWombatPulseTimer.SerialWombatPulseTimer(SW4B_6F)
    SW18AB_PT15 = SerialWombatPulseTimer.SerialWombatPulseTimer(SW4B_6F)
    SW18AB_PT16 = SerialWombatPulseTimer.SerialWombatPulseTimer(SW4B_6F)
    SW18AB_PT17 = SerialWombatPulseTimer.SerialWombatPulseTimer(SW4B_6E)
    SW18AB_PT18 = SerialWombatPulseTimer.SerialWombatPulseTimer(SW4B_6E)
    SW18AB_PT19 = SerialWombatPulseTimer.SerialWombatPulseTimer(SW4B_6E)
...
def setAnalogRatio(pin, ratio):
    ratio = _uint16(ratio)
    SW18AB_6B.sendPacket(bytearray([253, pin]) + SW_LE16(ratio) + bytearray([0x55, 0x55, 0x55, 0x55]))



def analogShutdown():
    SW18AB_6B.sendPacket(bytearray([252,0x55,0x55,0x55,0x55,0x55,0x55,0x55]))


def analog1k(pin):
    SW18AB_6B.sendPacket(bytearray([251, pin, 0x55, 0x55, 0x55, 0x55, 0x55, 0x55]))
