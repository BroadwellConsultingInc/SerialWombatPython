# Converted from Testing/SW4B_SW18AB_SW08B_AutomatedTest/FrequencyOutput.ino
import SerialWombat
...
SWFrequencyOutput18 = SerialWombatFrequencyOutput.SerialWombatFrequencyOutput_18AB(SW18AB_6B)
SWFrequencyOutput8 = SerialWombatFrequencyOutput.SerialWombatFrequencyOutput_18AB(SW8B_68)

def frequencyOutputTest(sw, pin):
  # TODO_MANUAL_CONVERSION: SerialWombatFrequencyOutput* fo = None
  if sw == SW18AB_6B:
