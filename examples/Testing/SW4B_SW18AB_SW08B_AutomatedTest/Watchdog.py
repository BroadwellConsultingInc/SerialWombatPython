# Converted from Testing/SW4B_SW18AB_SW08B_AutomatedTest/Watchdog.ino
import SerialWombat
...
swwd = SerialWombatWatchdog.SerialWombatWatchdog(SW18AB_6B)
def watchdogTest18AB():
  for pin in range(11, NUM_TEST_PINS):
    resetAll()
    ...
    delay(200)
    duration = pulseRead(SW18AB_6B,pin)
    if duration >30000  and  duration < 50000:
      pass
      # TODO_MANUAL_CONVERSION: pass(pin)
    else:
      fail(pin)
