# Converted from Testing/SW4B_SW18AB_SW08B_AutomatedTest/PulseTimer.ino
#
# This Arduino example contains C++ constructs or large firmware/data sections that require hand conversion
# to run as Python.  The original Arduino source is preserved below as comments so the example remains
# in the mirrored Python example tree for side-by-side review.

import SerialWombat
from ArduinoFunctions import delay, delayMicroseconds, millis

# Select and configure a Serial Wombat Python interface here, matching the pattern used in the other
# converted examples, before manually porting the Arduino-specific code below.
...
# Original Arduino source follows:
# /*
