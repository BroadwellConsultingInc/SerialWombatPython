# Converted from Boards/PCB0031_SW8B_GRIP/GRIP_Ex05_VoltageMeasurement/GRIP_Ex05_VoltageMeasurement.ino
import SerialWombat
...
def setup():
  ...
  print("Vary the servo input voltage to observe it change.")

def loop():

  delay(500)

  logicVoltage = grip.readSupplyVoltage_mV()
  servoVoltage = grip.readPowerVoltage_mv()

  c = [0] * (80)
  c = ("Logic: %d mV  servo: %d mV") % (logicVoltage, servoVoltage)
