# Converted from Boards/PCB0030_SW8B_Bridge/PCB0030_Ex01_HBridge/PCB0030_Ex01_HBridge.ino
import SerialWombat
...
import PCB0030_Bridge


bridgeBoard = PCB0030_Bridge.PCB0030_Bridge(sw)
...
def setup():
  ...
  if not bridgeBoard.isLatestFirmware():
