# Converted from YouTube/Elegoo37SensorKit/AnalogJoystick/AnalogJoystick.ino
import SerialWombat
...
joyX = SerialWombatAnalogInput.SerialWombatAnalogInput(swc)
joyY = SerialWombatAnalogInput.SerialWombatAnalogInput(swc)
button = SerialWombatDebouncedInput.SerialWombatDebouncedInput(swc)
servoX = SerialWombatServo.SerialWombatServo(swc)
servoY = SerialWombatServo.SerialWombatServo(swc)
...
def loop():
  ...
  trueDuration = button.readDurationInTrueState_mS()
  if trueDuration > 0:
    print(trueDuration)
