# Converted from YouTube/Elegoo37SensorKit/RGBLED/RGBLED.ino
import SerialWombat
...
red = SerialWombatPWM.SerialWombatPWM(SWC)
green = SerialWombatPWM.SerialWombatPWM(SWC)
blue = SerialWombatPWM.SerialWombatPWM(SWC)
def setup():
