# Converted from YouTube/Elegoo37SensorKit/PhotoInterrupter/PhotoInterrupter.ino
import SerialWombat
...
sensor = SerialWombatDebouncedInput.SerialWombatDebouncedInput(swc)
def setup():
